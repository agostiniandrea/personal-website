...
const strings = {
  en: {
    ...
    mobileFeedbackNudgeBody: "One dedicated to you, one matched by me.",
  ...
  it: {
    ...
    mobileFeedbackNudgeBody: "Uno dedicato a te, uno aggiunto da me.",
    mobileFeedbackNudgeCta: "Scopri come cresce",
    mobileFeedbackNudgeDismiss: "Chiudi l'invito al feedback Forest",
    mobileFeedbackNudgeTitle: "Il tuo feedback può far crescere due alberi reali.",
