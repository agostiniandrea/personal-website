...
export const longContentFeature: FeaturePrimaryProps = {
  ...
  description:
    "A comprehensive guide exploring the intricate details of modern web architecture, from microservices to serverless computing, and how they impact development workflows and business outcomes.",
  image: {
    url: "https://images.unsplash.com/photo-1499750310107-5fef28a66643",
...
export const specialCharactersFeature: FeaturePrimaryProps = {
  ...
  description:
    "How local businesses are embracing digital transformation to enhance customer experiences and streamline operations.",
  image: {
    url: "https://images.unsplash.com/photo-1499750310107-5fef28a66643",
