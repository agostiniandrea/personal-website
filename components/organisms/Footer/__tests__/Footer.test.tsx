...
describe('Footer', () => {
  ...
  it('renders footer with social links', () => {
    ...
    expect(instagramLink).toHaveAttribute('href', 'https://www.instagram.com/alice.diantonio/');
    expect(instagramLink).toHaveAttribute('target', '_blank');
    expect(instagramLink).toHaveAttribute('rel', 'noopener noreferrer');
    
    const tiktokLink = screen.getByRole('link', { name: 'TikTok' });
    expect(tiktokLink).toHaveAttribute('href', 'https://www.tiktok.com/@alicediantonio');
